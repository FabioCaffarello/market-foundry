...
Use this file to choose the right owner surface for repository work.
...
- code or file placement -> `repository-shape.md`
- pre/post-change loop -> `development-workflow.md`
- layer, runtime, or ownership boundary -> `architecture-boundaries.md`
- `make` vs `raccoon-cli` vs `scripts` -> `tooling-contracts.md`
- doc ownership -> `documentation-topology.md`
