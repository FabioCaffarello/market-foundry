...
fn execute(context: AppContext, command: Commands) -> Result<i32> {
    match command {
        ...
        Commands::Check(CheckCommands::Metrics) => emit_standard_report(
            &context,
        ...
        Commands::Check(CheckCommands::Subjects) => emit_standard_report(
            &context,
        ...
        Commands::Check(CheckCommands::Insights) => emit_standard_report(
            &context,
            analyzers::check_insights::analyze(&context.project_root)?,
        ),
        Commands::Check(CheckCommands::Delivery) => emit_standard_report(
            &context,
            analyzers::check_delivery::analyze(&context.project_root)?,
        ),
