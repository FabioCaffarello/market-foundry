...
func NewCandleConsumer(url string, spec natskit.ConsumerSpec, registry Registry, handler CandleHandler, logger *slog.Logger) *CandleConsumer {
...
func (c *CandleConsumer) Start() error {
...
func (c *CandleConsumer) onMessage(msg jetstream.Msg) {
	env, prob := natskit.DecodeEvent[evidence.CandleSampledEvent](c.registry.CandleSampled, msg.Data())
	if prob != nil {
...
func (c *CandleConsumer) terminateOrNak(msg jetstream.Msg, prob *problem.Problem) {
