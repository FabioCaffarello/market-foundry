...
// Handler is called for each decoded signal generated event.
type Handler func(signal.SignalGeneratedEvent)

// Consumer is a durable JetStream consumer for signal events.
...
func (c *Consumer) onMessage(msg jetstream.Msg) {
	env, prob := natskit.DecodeEvent[signal.SignalGeneratedEvent](c.spec.Event, msg.Data())
	if prob != nil {
