...
// ExecutionHandler is called for each decoded execution event.
type ExecutionHandler func(execution.PaperOrderSubmittedEvent)

// ExecutionConsumer is a durable JetStream consumer for execution events.
...
func NewExecutionConsumer(url string, spec ConsumerSpec, registry ExecutionRegistry, handler ExecutionHandler, logger *slog.Logger) *ExecutionConsumer {
...
func (c *ExecutionConsumer) Start() error {
...
func (c *ExecutionConsumer) onMessage(msg jetstream.Msg) {
	c.delivered.Add(1)
	...
	env, prob := decodeEvent[execution.PaperOrderSubmittedEvent](c.spec.Event, msg.Data())
	if prob != nil {
...
func (c *ExecutionConsumer) terminateOrNak(msg jetstream.Msg, prob *problem.Problem) {
...
func (c *ExecutionConsumer) Stats() (delivered, redelivered, terminated, nakked int64) {
