...
// EncodeControlRequest encodes a typed control request into CBOR bytes.
...
// DecodeControlRequest decodes a CBOR-encoded control request.
...
// EncodeControlReply encodes a typed control reply into CBOR bytes.
...
// DecodeControlReply decodes a CBOR-encoded control reply.
...
// EncodeEvent encodes a typed event into CBOR bytes.
...
// DecodeEvent decodes a CBOR-encoded event.
...
// ControlRoute binds a ControlSpec to a handler function.
type ControlRoute struct {
	Spec    ControlSpec
	Handler func(context.Context, []byte) ([]byte, error)
}

// NewTypedControlRoute creates a type-safe ControlRoute from a typed handler function.
