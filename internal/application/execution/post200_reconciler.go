...
func (r *Post200Reconciler) SubmitOrder(ctx context.Context, req ports.VenueOrderRequest) (ports.VenueOrderReceipt, *problem.Problem) {
	...
	recovered, queryProb := r.query.QueryOrder(queryCtx, clientOrderID, req.Intent.VenueSymbol()) //nolint:contextcheck // fresh ctx is deliberate — original ctx may have expired triggering this recovery path
	if queryProb != nil {
