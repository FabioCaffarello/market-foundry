...
// shape of this helper; it's duplicated here to keep each application
// package self-contained until H-6.c migrates evaluator constructors
// to accept CanonicalInstrument directly.
