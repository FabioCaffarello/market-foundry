-- Migration: 010_add_canonical_columns_decisions
-- Created: 2026-05-27
-- Description: Add canonical instrument columns (base/quote/contract) to
--              decisions per ADR-0021 criterion #4b.
...
-- Reversible: Yes (ALTER TABLE decisions DROP COLUMN base, DROP COLUMN quote,
