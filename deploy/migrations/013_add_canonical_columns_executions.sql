-- Migration: 013_add_canonical_columns_executions
-- Created: 2026-05-27
-- Description: Add canonical instrument columns (base/quote/contract) to
--              executions per ADR-0021 criterion #4b.
...
-- Reversible: Yes (ALTER TABLE executions DROP COLUMN base, DROP COLUMN quote,
